...
var StepZilla = function (_Component) {
  ...
  _createClass(StepZilla, [{
    ...
    value: function render() {
      ...
      if (componentPointer instanceof _react.Component || // unit test detecteed that instanceof Component can be in either of these locations so test both (not sure why this is the case)
